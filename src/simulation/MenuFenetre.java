...
public class MenuFenetre extends JMenuBar {
	...
	private void ajouterMenuFichier() {
		...
		menuCharger.addActionListener((ActionEvent e) -> {
			...
			if (returnValue == JFileChooser.APPROVE_OPTION) {
				...
				File selectedFile = new File("/Users/anthonykarabian/Desktop/ETS/LOG121/Log121 Labo1/src/ressources/configuration.xml");
				XMLParser xmlParser = new XMLParser(selectedFile);
	...
	private void ajouterMenuSimulation() {
		...
		menuChoisir.addActionListener((ActionEvent e) -> {
			// Ouvrir la fenétre de s�lection
